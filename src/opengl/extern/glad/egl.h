...
#include <KHR/khrplatform.h>
    ...
    typedef void(GLAD_API_PTR *EGLDEBUGPROCKHR)(EGLenum DERROR, const char *command, EGLint messageType, EGLLabelKHR threadLabel, EGLLabelKHR objectLabel, const char *message);
...
#define EGL_VERSION_1_4 1
    ...
    typedef EGLint(GLAD_API_PTR *PFNEGLGETDERRORPROC)(void);
...
#define eglGetDisplay glad_eglGetDisplay
    GLAD_API_CALL PFNEGLGETDERRORPROC glad_eglGetDERROR;
#define eglGetDERROR glad_eglGetDERROR
